...
#
# Created: Wed May  6 14:32:25 2015
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.fund_cat = QtGui.QComboBox(Dialog)
        self.fund_cat.setEditable(False)
        self.fund_cat.setInsertPolicy(QtGui.QComboBox.InsertAtCurrent)
        self.fund_cat.setObjectName(_fromUtf8("fund_cat"))
        self.fund_cat.addItems([u"创新性基金", u"ETF基金", u"LOF基金", u"封闭式基金"])
        self.horizontalLayout.addWidget(self.fund_cat)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(_translate("Dialog", "基金分类:", None))

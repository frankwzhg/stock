...
#
# Created: Fri May  8 14:14:19 2015
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.fund_cat, 0, 1, 1, 2)
        self.widget = top_stock_mat(self.centralwidget)
        self.widget.setEnabled(True)
        self.widget.setObjectName(_fromUtf8("widget"))
        self.gridLayout.addWidget(self.widget, 0, 3, 6, 1)
        ...
        self.gridLayout.addWidget(self.fund_code, 1, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.F_rate, 3, 2, 1, 1)
        ...
        self.top_stocks.setColumnWidth(2, 10)
        self.top_stocks.setObjectName(_fromUtf8("top_stocks"))
        self.gridLayout.addWidget(self.top_stocks, 5, 0, 1, 3)
